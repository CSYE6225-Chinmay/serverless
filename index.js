...
<html>
    ...
    <body>
      ...
      <p><a href=http://demo.chinmayashtikar.me/v1/user/verifyUserEmail?token=${token}&email=${email} >
        http://demo.chinmayashtikar.me/v1/user/verifyUserEmail?token=${token}&email=${email} </a> </p>
        </body></html>
    </body>
</html>`;
